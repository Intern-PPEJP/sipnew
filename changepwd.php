	...
	<div class="form-group row">
		<div class="input-group">
			...
			<div class="input-group-append">
				...
				<button type="button" class="btn btn-default ew-password-generator" title="<?php echo HtmlTitle($Language->phrase("GeneratePassword")) ?>" data-password-field="npwd" data-password-confirm="cpwd"><?php echo $Language->phrase("GeneratePassword") ?></button>
			</div>
		</div>
	</div>
	<div class="form-group row">

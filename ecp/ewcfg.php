...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "input_ecp"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '5S3u7WV2n3JHLmCA', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/input_ecp.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{9B9A621D-5170-4F08-8852-72A13BB88C54}", // Project ID (GUID)
	...
	"ADMIN_USER_NAME" => "ppejp", // Administrator user name

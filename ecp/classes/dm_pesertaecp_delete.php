 ...
 * Page class
 */
class dm_pesertaecp_delete extends dm_pesertaecp
{
	...
	// Page object name
	public $PageObjName = "dm_pesertaecp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("dm_pesertaecplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("dm_pesertaecplist.php"); // Return to list
			}
		}
	}

 ...
 * Page class
 */
class dm_ecp_delete extends dm_ecp
{
	...
	// Page object name
	public $PageObjName = "dm_ecp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("dm_ecplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("dm_ecplist.php"); // Return to list
			}
		}
	}

...
/**
 * Table class for dm_ecp
 */
class dm_ecp extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'dm_ecp';
		$this->TableName = 'dm_ecp';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`dm_ecp`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID_ECP
		$this->ID_ECP = new DbField('dm_ecp', 'dm_ecp', 'x_ID_ECP', 'ID_ECP', '`ID_ECP`', '`ID_ECP`', 3, 9, -1, FALSE, '`ID_ECP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// Nama
		$this->Nama = new DbField('dm_ecp', 'dm_ecp', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Nullable = FALSE; // NOT NULL field
		$this->Nama->Required = TRUE; // Required field
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->Nama->Lookup = new Lookup('Nama', 'dm_pesertaecp', FALSE, 'Nama', ["Nama","","",""], [], [], [], [], [], [], '', '');
		$this->fields['Nama'] = &$this->Nama;

		// Perusahaan
		$this->Perusahaan = new DbField('dm_ecp', 'dm_ecp', 'x_Perusahaan', 'Perusahaan', '`Perusahaan`', '`Perusahaan`', 200, 255, -1, FALSE, '`Perusahaan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Perusahaan->Lookup = new Lookup('Perusahaan', 'dm_pesertaecp', FALSE, 'Perusahaan', ["Perusahaan","","",""], [], [], [], [], [], [], '', '');
		$this->fields['Perusahaan'] = &$this->Perusahaan;

		// Daerah
		$this->Daerah = new DbField('dm_ecp', 'dm_ecp', 'x_Daerah', 'Daerah', '`Daerah`', '`Daerah`', 200, 100, -1, FALSE, '`Daerah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Produk
		$this->Produk = new DbField('dm_ecp', 'dm_ecp', 'x_Produk', 'Produk', '`Produk`', '`Produk`', 200, 255, -1, FALSE, '`Produk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tgl_Bln_Ekspor
		$this->Tgl_Bln_Ekspor = new DbField('dm_ecp', 'dm_ecp', 'x_Tgl_Bln_Ekspor', 'Tgl_Bln_Ekspor', '`Tgl_Bln_Ekspor`', '`Tgl_Bln_Ekspor`', 200, 50, -1, FALSE, '`Tgl_Bln_Ekspor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Negara_Tujuan
		$this->Negara_Tujuan = new DbField('dm_ecp', 'dm_ecp', 'x_Negara_Tujuan', 'Negara_Tujuan', '`Negara_Tujuan`', '`Negara_Tujuan`', 200, 100, -1, FALSE, '`Negara_Tujuan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nilai_Ekspor_USD
		$this->Nilai_Ekspor_USD = new DbField('dm_ecp', 'dm_ecp', 'x_Nilai_Ekspor_USD', 'Nilai_Ekspor_USD', '`Nilai_Ekspor_USD`', '`Nilai_Ekspor_USD`', 131, 15, -1, FALSE, '`Nilai_Ekspor_USD`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Nilai_Ekspor_Rupiah
		$this->Nilai_Ekspor_Rupiah = new DbField('dm_ecp', 'dm_ecp', 'x_Nilai_Ekspor_Rupiah', 'Nilai_Ekspor_Rupiah', '`Nilai_Ekspor_Rupiah`', '`Nilai_Ekspor_Rupiah`', 131, 15, -1, FALSE, '`Nilai_Ekspor_Rupiah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Keterangan
		$this->Keterangan = new DbField('dm_ecp', 'dm_ecp', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 200, 255, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Wilayah_ECP
		$this->Wilayah_ECP = new DbField('dm_ecp', 'dm_ecp', 'x_Wilayah_ECP', 'Wilayah_ECP', '`Wilayah_ECP`', '`Wilayah_ECP`', 200, 100, -1, FALSE, '`Wilayah_ECP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->Wilayah_ECP->Lookup = new Lookup('Wilayah_ECP', 'dm_ecp', TRUE, 'Wilayah_ECP', ["Wilayah_ECP","","",""], [], [], [], [], [], [], '', '');
		$this->fields['Wilayah_ECP'] = &$this->Wilayah_ECP;

		// Tahun_ECP
		$this->Tahun_ECP = new DbField('dm_ecp', 'dm_ecp', 'x_Tahun_ECP', 'Tahun_ECP', '`Tahun_ECP`', '`Tahun_ECP`', 2, 4, -1, FALSE, '`Tahun_ECP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`dm_ecp`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "dm_ecpedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "dm_ecpadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("dm_ecpview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("dm_ecpview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "dm_ecpadd.php?" . $this->getUrlParm($parm);
		else
			$url = "dm_ecpadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("dm_ecpedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("dm_ecpadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("dm_ecpdelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		$this->Negara_Tujuan->EditValue = $this->Negara_Tujuan->CurrentValue;

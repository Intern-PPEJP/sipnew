            ...
            <nav class="<?= Config("NAVBAR_CLASS") ?>">
                ...
                <ul id="ew-navbar" class="navbar-nav">
                    ...
                    <a class="navbar-brand d-none d-md-block" href="#" onclick="return false;">
                        <span class="brand-text">IMPOR DATA >></span>
                    </a>
                </ul>
                <!-- Right navbar links -->
    ...
    <div id="ew-import-dialog" class="modal" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-default ew-close-btn" data-dismiss="modal"><?= $Language->phrase("CloseBtn") ?></button></div>
            </div>
        </div>
    </div>
    <!-- tooltip -->

...
class PesertaList extends Peserta
{
    ...
    public function run()
    {
        ...
        $this->setupLookupOptions($this->kdsex);
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->harapan->AdvancedSearch->toJson(), ","); // Field harapan
    ...
    protected function restoreFilterList()
    {
        ...
        // Field harapan
        $this->harapan->AdvancedSearch->SearchValue = @$filter["x_harapan"];
        $this->harapan->AdvancedSearch->SearchOperator = @$filter["z_harapan"];
        $this->harapan->AdvancedSearch->SearchCondition = @$filter["v_harapan"];
        $this->harapan->AdvancedSearch->SearchValue2 = @$filter["y_harapan"];
        $this->harapan->AdvancedSearch->SearchOperator2 = @$filter["w_harapan"];
        $this->harapan->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->harapan, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tlahir); // tlahir

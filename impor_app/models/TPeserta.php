 ...
 */
class TPeserta extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // id
        $this->id = new DbField('t_peserta', 't_peserta', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, false, '`id`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // idp
        $this->idp = new DbField('t_peserta', 't_peserta', 'x_idp', 'idp', '`idp`', '`idp`', 3, 11, -1, false, '`idp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdprop
        $this->kdprop = new DbField('t_peserta', 't_peserta', 'x_kdprop', 'kdprop', '`kdprop`', '`kdprop`', 3, 11, -1, false, '`kdprop`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdkota
        $this->kdkota = new DbField('t_peserta', 't_peserta', 'x_kdkota', 'kdkota', '`kdkota`', '`kdkota`', 3, 11, -1, false, '`kdkota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdkec
        $this->kdkec = new DbField('t_peserta', 't_peserta', 'x_kdkec', 'kdkec', '`kdkec`', '`kdkec`', 3, 7, -1, false, '`kdkec`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdsex
        $this->kdsex = new DbField('t_peserta', 't_peserta', 'x_kdsex', 'kdsex', '`kdsex`', '`kdsex`', 3, 11, -1, false, '`kdsex`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdjabat
        $this->kdjabat = new DbField('t_peserta', 't_peserta', 'x_kdjabat', 'kdjabat', '`kdjabat`', '`kdjabat`', 3, 11, -1, false, '`kdjabat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdagama
        $this->kdagama = new DbField('t_peserta', 't_peserta', 'x_kdagama', 'kdagama', '`kdagama`', '`kdagama`', 3, 11, -1, false, '`kdagama`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->kdagama->Sortable = true; // Allow sort
        $this->kdagama->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->kdagama->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->kdagama->Param, "CustomMsg");
        $this->Fields['kdagama'] = &$this->kdagama;

        // kdpend
        $this->kdpend = new DbField('t_peserta', 't_peserta', 'x_kdpend', 'kdpend', '`kdpend`', '`kdpend`', 3, 11, -1, false, '`kdpend`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdbahasa
        $this->kdbahasa = new DbField('t_peserta', 't_peserta', 'x_kdbahasa', 'kdbahasa', '`kdbahasa`', '`kdbahasa`', 3, 11, -1, false, '`kdbahasa`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->kdbahasa->Sortable = true; // Allow sort
        $this->kdbahasa->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->kdbahasa->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->kdbahasa->Param, "CustomMsg");
        ...
        // kdinformasi
        $this->kdinformasi = new DbField('t_peserta', 't_peserta', 'x_kdinformasi', 'kdinformasi', '`kdinformasi`', '`kdinformasi`', 3, 5, -1, false, '`kdinformasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // imp
        $this->imp = new DbField('t_peserta', 't_peserta', 'x_imp', 'imp', '`imp`', '`imp`', 16, 1, -1, false, '`imp`', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->imp->Sortable = true; // Allow sort
        $this->imp->DataType = DATATYPE_BOOLEAN;
        $this->imp->Lookup = new Lookup('imp', 't_peserta', false, '', ["","","",""], [], [], [], [], [], [], '', '');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("tpesertalist");
    }
    ...
    {
        global $Language;
        if ($pageName == "tpesertaview") {
            return $Language->phrase("View");
        } elseif ($pageName == "tpesertaedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "tpesertaadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("tpesertaview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("tpesertaview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "tpesertaadd?" . $this->getUrlParm($parm);
        } else {
            $url = "tpesertaadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("tpesertaedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("tpesertaadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("tpesertadelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        $this->idp->ViewValue = FormatNumber($this->idp->ViewValue, 0, -2, -2, -2);
        ...
        $this->kdsex->ViewValue = FormatNumber($this->kdsex->ViewValue, 0, -2, -2, -2);
        ...
        $this->kdjabat->ViewValue = FormatNumber($this->kdjabat->ViewValue, 0, -2, -2, -2);
        $this->kdjabat->ViewCustomAttributes = "";

        // kdagama
        $this->kdagama->ViewValue = $this->kdagama->CurrentValue;
        $this->kdagama->ViewValue = FormatNumber($this->kdagama->ViewValue, 0, -2, -2, -2);
        $this->kdagama->ViewCustomAttributes = "";

        // kdpend
        $this->kdpend->ViewValue = $this->kdpend->CurrentValue;
        $this->kdpend->ViewValue = FormatNumber($this->kdpend->ViewValue, 0, -2, -2, -2);
        $this->kdpend->ViewCustomAttributes = "";

        // kdbahasa
        $this->kdbahasa->ViewValue = $this->kdbahasa->CurrentValue;
        $this->kdbahasa->ViewValue = FormatNumber($this->kdbahasa->ViewValue, 0, -2, -2, -2);
    ...
    public function renderEditRow()
    {
        ...
        // kdsex
        $this->kdsex->EditAttrs["class"] = "form-control";
        $this->kdsex->EditCustomAttributes = "";
        $this->kdsex->EditValue = $this->kdsex->CurrentValue;
        ...
        $this->kdjabat->EditValue = $this->kdjabat->CurrentValue;
        ...
        $this->kdagama->EditValue = $this->kdagama->CurrentValue;
        $this->kdagama->PlaceHolder = RemoveHtml($this->kdagama->caption());

        // kdpend
        $this->kdpend->EditAttrs["class"] = "form-control";
        $this->kdpend->EditCustomAttributes = "";
        $this->kdpend->EditValue = $this->kdpend->CurrentValue;
        ...
        $this->kdbahasa->EditValue = $this->kdbahasa->CurrentValue;
        $this->kdbahasa->PlaceHolder = RemoveHtml($this->kdbahasa->caption());

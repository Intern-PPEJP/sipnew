...
/**
 * Table class for pelpes
 */
class Pelpes extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pelpes';
        $this->TableName = 'pelpes';
        ...
        // kdhistori
        $this->kdhistori = new DbField('pelpes', 'pelpes', 'x_kdhistori', 'kdhistori', 't_pp.kdhistori', 't_pp.kdhistori', 3, 25, -1, false, 't_pp.kdhistori', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // kdpelat
        $this->kdpelat = new DbField('pelpes', 'pelpes', 'x_kdpelat', 'kdpelat', 't_pp.kdpelat', 't_pp.kdpelat', 200, 20, -1, false, 't_pp.kdpelat', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id
        $this->id = new DbField('pelpes', 'pelpes', 'x_id', 'id', 't_pp.id', 't_pp.id', 3, 11, -1, false, 't_pp.id', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->id->Sortable = true; // Allow sort
        $this->id->Lookup = new Lookup('id', 't_peserta', false, 'id', ["id","nama","",""], [], [], [], [], [], [], '', '');
        $this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->id->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id->Param, "CustomMsg");
        $this->Fields['id'] = &$this->id;

        // tahun
        $this->tahun = new DbField('pelpes', 'pelpes', 'x_tahun', 'tahun', 't_pp.tahun', 't_pp.tahun', 2, 6, -1, false, 't_pp.tahun', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("t_pp.kdhistori, t_pp.kdpelat, t_pp.id, t_pp.tahun");
    }
    ...
    {
        $where = ($this->SqlWhere != "") ? $this->SqlWhere : "t_pp.imp = 1";
        $this->DefaultFilter = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("pelpeslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "pelpesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "pelpesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "pelpesadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("pelpesview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("pelpesview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "pelpesadd?" . $this->getUrlParm($parm);
        } else {
            $url = "pelpesadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("pelpesedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("pelpesadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("pelpesdelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->kdhistori->PlaceHolder = RemoveHtml($this->kdhistori->caption());

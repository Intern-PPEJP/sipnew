...
var ew = (function () {
  ...
  // Nashorn ~ JDK8 bug
  var NASHORN_BUG =
    getOwnPropertyDescriptor$4 && !$propertyIsEnumerable$1.call({ 1: 2 }, 1);
  ...
  var toInteger = function (argument) {
    return isNaN((argument = +argument))
      ? 0
      : (argument > 0 ? floor$2 : ceil)(argument);
  };
  ...
  */
  ...
  var isArrayIteratorMethod = function (it) {
    return (
      it !== undefined &&
      (iterators.Array === it || ArrayPrototype[ITERATOR$7] === it)
    );
  };
  ...
  var getIteratorMethod = function (it) {
    if (it != undefined)
      return it[ITERATOR$6] || it["@@iterator"] || iterators[classof(it)];
  };
      ...
      if (
        ...
        if (
          ...
          if (objectSetPrototypeOf) {
            ...
            typeof CurrentIteratorPrototype[ITERATOR$3] != "function"
          ) {
  ...
  _export(
    ...
    },
    {
      endsWith: function endsWith(searchString /* , endPosition = @length */) {
        ...
        var end =
          endPosition === undefined ? len : min$1(toLength(endPosition), len);
  ...
  var $getOwnPropertyNames = function getOwnPropertyNames(O) {
    ...
    $forEach(names, function (key) {
      if (!has$1(AllSymbols, key) && !has$1(hiddenKeys$1, key))
        result.push(key);
    });
    return result;
  };
  ...
  var percentEncode = function (char, set) {
    ...
    return code > 0x20 && code < 0x7f && !has$1(set, char)
      ? char
    ...
    if (rafPrefix) {
      ...
      if (!global.cancelAnimationFrame)
        ...
        global.cancelAnimationFrame =
          global[rafPrefix + "CancelAnimationFrame"];
    } else {
  ...
  (function () {
    ...
    var attributesObserver = function attributesObserver(
      whenDefined,
      MutationObserver
    ) {
      ...
      var loop = function loop(elements, connected, query) {
        ...
        var _loop = function _loop(_selectors, _element, i, length) {
          ...
          if (!set.has((_element = elements[i]))) {
            ...
            if (connected) {
              for (
                var q, m = matches(_element), _i = 0, _length = query.length;
                _i < _length;
                _i++
              ) {
        ...
        for (
          var selectors, element, i = 0, length = elements.length;
          i < length;
          i++
        ) {
      ...
      defineProperty(customElements, "define", {
        ...
        value: function value(is, Class, options) {
          ...
          if (tag) {
            if (getCE(is))
              throw new Error(
                "'".concat(is, "' has already been defined as a custom element")
              );
  ...
  var SelectionList = /*#__PURE__*/ (function (_HTMLInputElement) {
    ...
    _proto.connectedCallback = function connectedCallback() {
      ...
      for (
        var _iterator = _createForOfIteratorHelperLoose(values), _step;
    ...
    _proto.clear = function clear() {
      for (
        var _iterator2 = _createForOfIteratorHelperLoose(this.options), _step2;
        ...
        options.forEach(function (option, i) {
          ...
          input.addEventListener("click", function () {
            ...
            if (self.type == "select-one") {
              for (
                var _iterator3 = _createForOfIteratorHelperLoose(self.options),
                  _step3;
    ...
    _proto.focus = function focus() {
      if (this.list) {
        ...
        (_this$target = this.target) === null || _this$target === void 0
          ? void 0
          : (_this$target$querySel = _this$target.querySelector("input")) ===
              null || _this$target$querySel === void 0
          ? void 0
          : _this$target$querySel.focus();
      } else {
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          get: function get() {
            for (
              var _iterator4 = _createForOfIteratorHelperLoose(this.options),
                _step4;
          ...
          set:
            ...
            function set(val) {
              if (this.type == "select-one") {
                ...
                for (
                  var _iterator6 = _createForOfIteratorHelperLoose(
                      this.options
                    ),
                    _step6;
          ...
          get: function get() {
            if (this.type == "select-one" || this.type == "select-multiple") {
              return Array.prototype.filter
                .call(this.options, function (option) {
  ...
  ew$1.addSpinner = function () {
    ...
    div.innerHTML =
      '<span class="sr-only">' +
      (ew$1.language ? ew$1.language.phrase("Loading") : "Loading...") +
      "</span>";
  ...
  ew$1.loadjs = function (paths, arg1, arg2) {
    ...
    paths.forEach(function (path, i, ar) {
      if (i == ar.length - 1)
        // Last
        p = p.then(function () {
          return loadjs(path, bundleId || args, bundleId ? args : null).catch(
            function (paths) {

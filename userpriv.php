...
<input type="hidden" name="x_user_level_id" id="x_user_level_id" value="<?php echo $userpriv->user_level_id->CurrentValue ?>">
<div class="ew-desktop">
<div class="card ew-card ew-user-priv">
<div class="card-header">
	<h3 class="card-title"><?php echo $Language->phrase("UserLevel") ?><?php echo $Security->getUserLevelName((int)$userpriv->user_level_id->CurrentValue) ?> (<?php echo $userpriv->user_level_id->CurrentValue ?>)</h3>

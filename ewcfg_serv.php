...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "ppei_20"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'UcKg9xByfWZnOXQc', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/ppei_20.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{046BD04F-8A8B-497E-98E3-47339F0B2FB6}", // Project ID (GUID)
	...
	"USER_LEVEL_PRIV_TABLE" => "`t_userlevelpermissions`",
	...
	"UPLOAD_DEST_PATH" => "berkas/", // Upload destination path (relative to app root)
	...
	"UPLOAD_ALLOWED_FILE_EXT" => "pdf,csv,xls,xlsx,jpg,jpeg,png", // Allowed file extensions
	...
	"EXPORT_ALL_TIME_LIMIT" => 360, // Export all records time limit

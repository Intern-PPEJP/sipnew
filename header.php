...
<div class="wrapper ew-layout">
	...
	<nav class="<?php echo Config("NAVBAR_CLASS") ?>">
		...
		<ul id="ew-navbar" class="navbar-nav">
			...
			<a class="navbar-brand d-none" href="#"  onclick="return false;">
				<img src="<?php echo $RELATIVE_PATH ?>images/Logo_Kementerian_Perdagangan_Republik_Indonesia-dark.png" alt="" class="brand-image ew-brand-image">
			</a>
		</ul>
		<!-- Right navbar links -->
	...
	<aside class="<?php echo Config("SIDEBAR_CLASS") ?>">
		<a href="#" class="brand-link">
			<img src="<?php echo $RELATIVE_PATH ?>images/Logo_Kementerian_Perdagangan_Republik_Indonesia-dark.png" alt="" class="brand-image ew-brand-image">
			<div id="jam" style="float:right;font-size: 8pt;text-align:right;"></div>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->

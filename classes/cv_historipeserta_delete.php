 ...
 * Page class
 */
class cv_historipeserta_delete extends cv_historipeserta
{
	...
	// Page object name
	public $PageObjName = "cv_historipeserta_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cv_historipesertalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cv_historipesertalist.php"); // Return to list
			}
		}
	}

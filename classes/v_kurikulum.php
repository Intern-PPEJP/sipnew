...
/**
 * Table class for v_kurikulum
 */
class v_kurikulum extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_kurikulum';
		$this->TableName = 'v_kurikulum';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_kurikulum`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// kurikulumid
		$this->kurikulumid = new DbField('v_kurikulum', 'v_kurikulum', 'x_kurikulumid', 'kurikulumid', '`kurikulumid`', '`kurikulumid`', 3, 11, -1, FALSE, '`kurikulumid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// kdjudul
		$this->kdjudul = new DbField('v_kurikulum', 'v_kurikulum', 'x_kdjudul', 'kdjudul', '`kdjudul`', '`kdjudul`', 200, 9, -1, FALSE, '`kdjudul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kurikulum
		$this->kurikulum = new DbField('v_kurikulum', 'v_kurikulum', 'x_kurikulum', 'kurikulum', '`kurikulum`', '`kurikulum`', 200, 255, -1, FALSE, '`kurikulum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->kurikulum->Required = TRUE; // Required field
		$this->kurikulum->Sortable = TRUE; // Allow sort
		$this->fields['kurikulum'] = &$this->kurikulum;

		// revisi
		$this->revisi = new DbField('v_kurikulum', 'v_kurikulum', 'x_revisi', 'revisi', '`revisi`', '`revisi`', 200, 2, -1, FALSE, '`revisi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->revisi->Required = TRUE; // Required field
		$this->revisi->Sortable = TRUE; // Allow sort
		$this->fields['revisi'] = &$this->revisi;

		// judul
		$this->judul = new DbField('v_kurikulum', 'v_kurikulum', 'x_judul', 'judul', '`judul`', '`judul`', 201, 65535, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_kurikulum`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_kurikulumview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_kurikulumedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_kurikulumadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_kurikulumview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_kurikulumview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_kurikulumadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_kurikulumadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_kurikulumedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_kurikulumadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_kurikulumdelete.php", $this->getUrlParm());
	}

 ...
 * Page class
 */
class t_rwpekerjaan_delete extends t_rwpekerjaan
{
	...
	// Page object name
	public $PageObjName = "t_rwpekerjaan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_rwpekerjaanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_rwpekerjaanlist.php"); // Return to list
			}
		}
	}

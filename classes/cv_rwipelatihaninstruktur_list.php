 ...
 * Page class
 */
class cv_rwipelatihaninstruktur_list extends cv_rwipelatihaninstruktur
{
	...
	// Table name
	public $TableName = 'cv_rwipelatihaninstruktur';

	// Page object name
	public $PageObjName = "cv_rwipelatihaninstruktur_list";

	// Grid form hidden field names
	public $FormName = "fcv_rwipelatihaninstrukturlist";
	...
	public function __construct()
	{
		...
		// Table object (cv_rwipelatihaninstruktur)
		if (!isset($GLOBALS["cv_rwipelatihaninstruktur"]) || get_class($GLOBALS["cv_rwipelatihaninstruktur"]) == PROJECT_NAMESPACE . "cv_rwipelatihaninstruktur") {
			$GLOBALS["cv_rwipelatihaninstruktur"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["cv_rwipelatihaninstruktur"];
		}
		...
		$this->AddUrl = "cv_rwipelatihaninstrukturadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "cv_rwipelatihaninstrukturdelete.php";
		$this->MultiUpdateUrl = "cv_rwipelatihaninstrukturupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'cv_rwipelatihaninstruktur');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fcv_rwipelatihaninstrukturlistsrch";
	...
	public function terminate($url = "")
	{
		...
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($cv_rwipelatihaninstruktur);
				$doc->Text = @$content;
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fcv_rwipelatihaninstrukturlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcv_rwipelatihaninstrukturlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fcv_rwipelatihaninstrukturlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";

 ...
 * Page class
 */
class t_pendidikan_add extends t_pendidikan
{
	...
	// Page object name
	public $PageObjName = "t_pendidikan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdpend") !== NULL) {
				...
				$this->setKey("kdpend", $this->kdpend->CurrentValue); // Set up key
			} else {
				$this->setKey("kdpend", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_pendidikanview.php")

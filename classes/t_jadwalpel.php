...
/**
 * Table class for t_jadwalpel
 */
class t_jadwalpel extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't_jadwalpel';
		$this->TableName = 't_jadwalpel';
		...
		// idjadwal
		$this->idjadwal = new DbField('t_jadwalpel', 't_jadwalpel', 'x_idjadwal', 'idjadwal', '`idjadwal`', '`idjadwal`', 3, 11, -1, FALSE, '`idjadwal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// idpelat
		$this->idpelat = new DbField('t_jadwalpel', 't_jadwalpel', 'x_idpelat', 'idpelat', '`idpelat`', '`idpelat`', 3, 11, -1, FALSE, '`idpelat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kdjudul
		$this->kdjudul = new DbField('t_jadwalpel', 't_jadwalpel', 'x_kdjudul', 'kdjudul', '`kdjudul`', '`kdjudul`', 200, 9, -1, FALSE, '`kdjudul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl
		$this->tgl = new DbField('t_jadwalpel', 't_jadwalpel', 'x_tgl', 'tgl', '`tgl`', CastDateFieldForLike("`tgl`", 0, "DB"), 133, 10, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jam
		$this->jam = new DbField('t_jadwalpel', 't_jadwalpel', 'x_jam', 'jam', '`jam`', CastDateFieldForLike("`jam`", 4, "DB"), 134, 10, 4, FALSE, '`jam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jam_akhir
		$this->jam_akhir = new DbField('t_jadwalpel', 't_jadwalpel', 'x_jam_akhir', 'jam_akhir', '`jam_akhir`', CastDateFieldForLike("`jam_akhir`", 4, "DB"), 134, 10, 4, FALSE, '`jam_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kurikulumid
		$this->kurikulumid = new DbField('t_jadwalpel', 't_jadwalpel', 'x_kurikulumid', 'kurikulumid', '`kurikulumid`', '`kurikulumid`', 3, 11, -1, FALSE, '`kurikulumid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// materi
		$this->materi = new DbField('t_jadwalpel', 't_jadwalpel', 'x_materi', 'materi', '`materi`', '`materi`', 201, 65535, -1, FALSE, '`materi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->materi->Sortable = TRUE; // Allow sort
		$this->materi->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->materi->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->materi->Lookup = new Lookup('materi', 't_kurikulum', FALSE, 'kurikulumid', ["kurikulum","","",""], [], [], [], [], [], [], '', '');
		$this->fields['materi'] = &$this->materi;

		// instruktur
		$this->instruktur = new DbField('t_jadwalpel', 't_jadwalpel', 'x_instruktur', 'instruktur', '`instruktur`', '`instruktur`', 200, 50, -1, FALSE, '`instruktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->instruktur->Sortable = TRUE; // Allow sort
		$this->instruktur->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->instruktur->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->instruktur->Lookup = new Lookup('instruktur', 'v_faskurdetail', TRUE, 'bioid', ["nama","kurikulum","",""], [], [], [], [], [], [], '', '');
		$this->instruktur->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['instruktur'] = &$this->instruktur;

		// instansi
		$this->instansi = new DbField('t_jadwalpel', 't_jadwalpel', 'x_instansi', 'instansi', '`instansi`', '`instansi`', 200, 255, -1, FALSE, '`instansi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->instansi->Sortable = TRUE; // Allow sort
		$this->fields['instansi'] = &$this->instansi;

		// ket
		$this->ket = new DbField('t_jadwalpel', 't_jadwalpel', 'x_ket', 'ket', '`ket`', '`ket`', 200, 50, -1, FALSE, '`ket`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "t_pelatihan") {
			if ($this->idpelat->getSessionValue() != "")
				$masterFilter .= "`idpelat`=" . QuotedValue($this->idpelat->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
	...
	{
		return "`idpelat`=@idpelat@ AND `kdjudul`='@kdjudul@'";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t_jadwalpeledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t_jadwalpeladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t_jadwalpelview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t_jadwalpelview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t_jadwalpeladd.php?" . $this->getUrlParm($parm);
		else
			$url = "t_jadwalpeladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_jadwalpeledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_jadwalpeladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t_jadwalpeldelete.php", $this->getUrlParm());
	}
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$cek_jadwal_instruktur = ExecuteScalar("SELECT COUNT(1) FROM `t_jadwalpel` WHERE `instruktur` = '".$rsnew["instruktur"]."' AND `tgl` = '".$rsnew["tgl"]."' AND `idpelat` != '".$rsnew["idpelat"]."'");
		if($cek_jadwal_instruktur > 0){
			$nm_instr = ExecuteScalar("SELECT nama FROM `t_biointruktur` WHERE `bioid` = '".$rsnew["instruktur"]."'");
			$this->setFailureMessage("Instruktur a/n <b>".$nm_instr."</b> sudah terjadwal!");
			return FALSE;
		}
		return TRUE;
	}
	...
	function Lookup_Selecting($fld, &$filter) {
		...
		if ($fld->Name == "materi")
			 AddFilter($filter, "kdjudul = '".$GLOBALS["t_pelatihan"]->kdjudul->CurrentValue."'");
	}
	...
	function Row_Rendered() {
		...
		$this->tgl->ViewValue = CSFormatTanggal(date("j-m-Y",strtotime($this->tgl->CurrentValue)), false, true, true, true);

 ...
 * Page class
 */
class t_juduldetail_delete extends t_juduldetail
{
	...
	// Page object name
	public $PageObjName = "t_juduldetail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_juduldetaillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_juduldetaillist.php"); // Return to list
			}
		}
	}

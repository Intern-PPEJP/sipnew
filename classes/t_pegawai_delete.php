 ...
 * Page class
 */
class t_pegawai_delete extends t_pegawai
{
	...
	// Page object name
	public $PageObjName = "t_pegawai_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_pegawailist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_pegawailist.php"); // Return to list
			}
		}
	}

 ...
 * Page class
 */
class t_rwtraining_delete extends t_rwtraining
{
	...
	// Page object name
	public $PageObjName = "t_rwtraining_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_rwtraininglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_rwtraininglist.php"); // Return to list
			}
		}
	}

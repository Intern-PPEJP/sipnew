...
class t_pcp_add extends t_pcp
{
	...
	protected function loadDefaultValues()
	{
		...
		$this->f_sertifikat->CurrentValue = NULL; // Clear file related field
	...
	protected function validateForm()
	{
		...
		if (in_array("t_ecp", $detailTblVar) && $GLOBALS["t_ecp"]->DetailAdd) {
	...
	protected function addRow($rsold = NULL)
	{
		...
		// alamat_prod
		$this->alamat_prod->setDbValueDef($rsnew, $this->alamat_prod->CurrentValue, NULL, FALSE);
		...
		// ig
		$this->ig->setDbValueDef($rsnew, $this->ig->CurrentValue, NULL, FALSE);

		// sosmed_lain
		$this->sosmed_lain->setDbValueDef($rsnew, $this->sosmed_lain->CurrentValue, NULL, FALSE);
		...
		if ($this->f_npwp->Visible && !$this->f_npwp->Upload->KeepFile) {
			$this->f_npwp->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_nib->Visible && !$this->f_nib->Upload->KeepFile) {
			$this->f_nib->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_siup->Visible && !$this->f_siup->Upload->KeepFile) {
			$this->f_siup->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_tdp->Visible && !$this->f_tdp->Upload->KeepFile) {
			$this->f_tdp->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_lain->Visible && !$this->f_lain->Upload->KeepFile) {
			$this->f_lain->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_sertifikat->Visible && !$this->f_sertifikat->Upload->KeepFile) {
			$this->f_sertifikat->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_kartunama->Visible && !$this->f_kartunama->Upload->KeepFile) {
			$this->f_kartunama->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_brosur->Visible && !$this->f_brosur->Upload->KeepFile) {
			$this->f_brosur->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_katalog->Visible && !$this->f_katalog->Upload->KeepFile) {
			$this->f_katalog->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_profile->Visible && !$this->f_profile->Upload->KeepFile) {
			$this->f_profile->Upload->DbValue = ""; // No need to delete old file
		...
		if ($this->f_npwp->Visible && !$this->f_npwp->Upload->KeepFile) {
			...
			if (!EmptyValue($this->f_npwp->Upload->FileName)) {
				...
				$this->f_npwp->setDbValueDef($rsnew, $this->f_npwp->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_nib->Visible && !$this->f_nib->Upload->KeepFile) {
			$this->f_nib->UploadPath = "berkas/legalitas_ecp/";
			...
			if (!EmptyValue($this->f_nib->Upload->FileName)) {
				...
				$this->f_nib->setDbValueDef($rsnew, $this->f_nib->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_siup->Visible && !$this->f_siup->Upload->KeepFile) {
			$this->f_siup->UploadPath = "berkas/legalitas_ecp/";
			...
			if (!EmptyValue($this->f_siup->Upload->FileName)) {
				...
				$this->f_siup->setDbValueDef($rsnew, $this->f_siup->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_tdp->Visible && !$this->f_tdp->Upload->KeepFile) {
			$this->f_tdp->UploadPath = "berkas/legalitas_ecp/";
			...
			if (!EmptyValue($this->f_tdp->Upload->FileName)) {
				...
				$this->f_tdp->setDbValueDef($rsnew, $this->f_tdp->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_lain->Visible && !$this->f_lain->Upload->KeepFile) {
			$this->f_lain->UploadPath = "berkas/legalitas_ecp/";
			...
			if (!EmptyValue($this->f_lain->Upload->FileName)) {
				...
				$this->f_lain->setDbValueDef($rsnew, $this->f_lain->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_sertifikat->Visible && !$this->f_sertifikat->Upload->KeepFile) {
			$this->f_sertifikat->UploadPath = "berkas/sertifikat_ecp/";
			...
			if (!EmptyValue($this->f_sertifikat->Upload->FileName)) {
				...
				$this->f_sertifikat->setDbValueDef($rsnew, $this->f_sertifikat->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_kartunama->Visible && !$this->f_kartunama->Upload->KeepFile) {
			$this->f_kartunama->UploadPath = "berkas/promosi_ecp/";
			...
			if (!EmptyValue($this->f_kartunama->Upload->FileName)) {
				...
				$this->f_kartunama->setDbValueDef($rsnew, $this->f_kartunama->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_brosur->Visible && !$this->f_brosur->Upload->KeepFile) {
			$this->f_brosur->UploadPath = "berkas/promosi_ecp/";
			...
			if (!EmptyValue($this->f_brosur->Upload->FileName)) {
				...
				$this->f_brosur->setDbValueDef($rsnew, $this->f_brosur->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_katalog->Visible && !$this->f_katalog->Upload->KeepFile) {
			$this->f_katalog->UploadPath = "berkas/promosi_ecp/";
			...
			if (!EmptyValue($this->f_katalog->Upload->FileName)) {
				...
				$this->f_katalog->setDbValueDef($rsnew, $this->f_katalog->Upload->FileName, NULL, FALSE);
			}
		}
		if ($this->f_profile->Visible && !$this->f_profile->Upload->KeepFile) {
			$this->f_profile->UploadPath = "berkas/promosi_ecp/";
			...
			if (!EmptyValue($this->f_profile->Upload->FileName)) {
				...
				$this->f_profile->setDbValueDef($rsnew, $this->f_profile->Upload->FileName, NULL, FALSE);
			}
		}
		...
		if ($addRow) {
			$detailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("t_ecp", $detailTblVar) && $GLOBALS["t_ecp"]->DetailAdd) {
				$GLOBALS["t_ecp"]->Peserta_ID->setSessionValue($this->id->CurrentValue); // Set master key
				if (!isset($GLOBALS["t_ecp_grid"]))
					$GLOBALS["t_ecp_grid"] = new t_ecp_grid(); // Get detail page object
				$Security->loadCurrentUserLevel($this->ProjectID . "t_ecp"); // Load user level of detail table
				$addRow = $GLOBALS["t_ecp_grid"]->gridInsert();
				$Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$addRow) {
					$GLOBALS["t_ecp"]->Peserta_ID->setSessionValue(""); // Clear master key if insert failed
				}
			}
		}
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("t_ecp", $detailTblVar)) {
				...
				if ($GLOBALS["t_ecp_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["t_ecp_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["t_ecp_grid"]->CurrentMode = "add";
					$GLOBALS["t_ecp_grid"]->CurrentAction = "gridadd";

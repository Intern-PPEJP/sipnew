 ...
 * Page class
 */
class t_rwpekerjaan_list extends t_rwpekerjaan
{
	...
	// Page object name
	public $PageObjName = "t_rwpekerjaan_list";

	// Grid form hidden field names
	public $FormName = "ft_rwpekerjaanlist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "t_rwpekerjaandelete.php";
		$this->MultiUpdateUrl = "t_rwpekerjaanupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft_rwpekerjaanlistsrch";
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->rwkerjaid->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft_rwpekerjaanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft_rwpekerjaanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.ft_rwpekerjaanlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";

 ...
 * Page class
 */
class t_repeserta_view extends t_repeserta
{
	...
	// Page object name
	public $PageObjName = "t_repeserta_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t_repesertalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t_repesertalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t_repesertalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {

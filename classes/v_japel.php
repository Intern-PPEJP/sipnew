...
/**
 * Table class for v_japel
 */
class v_japel extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_japel';
		$this->TableName = 'v_japel';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_japel`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// idpelat
		$this->idpelat = new DbField('v_japel', 'v_japel', 'x_idpelat', 'idpelat', '`idpelat`', '`idpelat`', 3, 11, -1, FALSE, '`idpelat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// idjadwal
		$this->idjadwal = new DbField('v_japel', 'v_japel', 'x_idjadwal', 'idjadwal', '`idjadwal`', '`idjadwal`', 3, 11, -1, FALSE, '`idjadwal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// kurikulumid
		$this->kurikulumid = new DbField('v_japel', 'v_japel', 'x_kurikulumid', 'kurikulumid', '`kurikulumid`', '`kurikulumid`', 3, 11, -1, FALSE, '`kurikulumid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// judul
		$this->judul = new DbField('v_japel', 'v_japel', 'x_judul', 'judul', '`judul`', '`judul`', 201, 65535, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->judul->Sortable = TRUE; // Allow sort
		$this->fields['judul'] = &$this->judul;

		// tawal
		$this->tawal = new DbField('v_japel', 'v_japel', 'x_tawal', 'tawal', '`tawal`', CastDateFieldForLike("`tawal`", 0, "DB"), 135, 19, 0, FALSE, '`tawal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// takhir
		$this->takhir = new DbField('v_japel', 'v_japel', 'x_takhir', 'takhir', '`takhir`', CastDateFieldForLike("`takhir`", 0, "DB"), 135, 19, 0, FALSE, '`takhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kota
		$this->kota = new DbField('v_japel', 'v_japel', 'x_kota', 'kota', '`kota`', '`kota`', 200, 100, -1, FALSE, '`kota`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kurikulum
		$this->kurikulum = new DbField('v_japel', 'v_japel', 'x_kurikulum', 'kurikulum', '`kurikulum`', '`kurikulum`', 200, 255, -1, FALSE, '`kurikulum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kurikulum->Sortable = TRUE; // Allow sort
		$this->fields['kurikulum'] = &$this->kurikulum;

		// kdkursil
		$this->kdkursil = new DbField('v_japel', 'v_japel', 'x_kdkursil', 'kdkursil', '`kdkursil`', '`kdkursil`', 200, 20, -1, FALSE, '`kdkursil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kdkursil->Sortable = TRUE; // Allow sort
		$this->fields['kdkursil'] = &$this->kdkursil;

		// instruktur
		$this->instruktur = new DbField('v_japel', 'v_japel', 'x_instruktur', 'instruktur', '`instruktur`', '`instruktur`', 200, 50, -1, FALSE, '`instruktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_japel`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_japelview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_japeledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_japeladd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_japelview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_japelview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_japeladd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_japeladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_japeledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_japeladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_japeldelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		if (!$this->kurikulum->Raw)
			$this->kurikulum->CurrentValue = HtmlDecode($this->kurikulum->CurrentValue);

 ...
 * Page class
 */
class cv_historipeserta_grid extends cv_historipeserta
{
	...
	// Table name
	public $TableName = 'cv_historipeserta';

	// Page object name
	public $PageObjName = "cv_historipeserta_grid";

	// Grid form hidden field names
	public $FormName = "fcv_historipesertagrid";
	...
	public function __construct()
	{
		...
		// Table object (cv_historipeserta)
		if (!isset($GLOBALS["cv_historipeserta"]) || get_class($GLOBALS["cv_historipeserta"]) == PROJECT_NAMESPACE . "cv_historipeserta") {
			$GLOBALS["cv_historipeserta"] = &$this;

			// $GLOBALS["MasterTable"] = &$GLOBALS["Table"];
			// if (!isset($GLOBALS["Table"]))
			// 	$GLOBALS["Table"] = &$GLOBALS["cv_historipeserta"];

		}
		$this->AddUrl = "cv_historipesertaadd.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'cv_historipeserta');
	...
	public function terminate($url = "")
	{
		...
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($cv_historipeserta);
				$doc->Text = @$content;
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			$keyValue = isset($rsnew['kdpelat']) ? $rsnew['kdpelat'] : $rsold['kdpelat'];
			if (strval($keyValue) != "") {
				$masterFilter = str_replace("@kdpelat@", AdjustSql($keyValue), $masterFilter);
			} else {
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Check referential integrity for master table 'cv_historipeserta'
		$validMasterRecord = TRUE;
		$masterFilter = $this->sqlMasterFilter_t_pelatihan();
		if (strval($this->kdpelat->CurrentValue) != "") {
			$masterFilter = str_replace("@kdpelat@", AdjustSql($this->kdpelat->CurrentValue, "DB"), $masterFilter);
		} else {
			$validMasterRecord = FALSE;
		}
		if ($validMasterRecord) {
	...
	function Page_Load() {
		...
		//echo "Page Load";
		$GLOBALS["ExportFileName"] = "Peserta_Pelatihan-PPE".CurrentDate();
	}

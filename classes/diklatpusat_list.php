 ...
 * Page class
 */
class diklatpusat_list extends diklatpusat
{
	...
	// Page object name
	public $PageObjName = "diklatpusat_list";

	// Grid form hidden field names
	public $FormName = "fdiklatpusatlist";
	...
	public function __construct()
	{
		...
		$this->MultiDeleteUrl = "diklatpusatdelete.php";
		$this->MultiUpdateUrl = "diklatpusatupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fdiklatpusatlistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fdiklatpusatlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdiklatpusatlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fdiklatpusatlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";

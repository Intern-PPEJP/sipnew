 ...
 * Page class
 */
class diklatkerjasama_view extends diklatkerjasama
{
	...
	// Page object name
	public $PageObjName = "diklatkerjasama_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idpelat") !== NULL) {
				...
				$returnUrl = "diklatkerjasamalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "diklatkerjasamalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "diklatkerjasamalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {

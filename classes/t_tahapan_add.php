 ...
 * Page class
 */
class t_tahapan_add extends t_tahapan
{
	...
	// Page object name
	public $PageObjName = "t_tahapan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdtahapan") !== NULL) {
				...
				$this->setKey("kdtahapan", $this->kdtahapan->CurrentValue); // Set up key
			} else {
				$this->setKey("kdtahapan", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_tahapanview.php")

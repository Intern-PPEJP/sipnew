 ...
 * Page class
 */
class cv_historipelatihanpeserta_delete extends cv_historipelatihanpeserta
{
	...
	// Page object name
	public $PageObjName = "cv_historipelatihanpeserta_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("cv_historipelatihanpesertalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("cv_historipelatihanpesertalist.php"); // Return to list
			}
		}
	}

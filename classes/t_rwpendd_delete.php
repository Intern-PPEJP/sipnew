 ...
 * Page class
 */
class t_rwpendd_delete extends t_rwpendd
{
	...
	// Page object name
	public $PageObjName = "t_rwpendd_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_rwpenddlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_rwpenddlist.php"); // Return to list
			}
		}
	}

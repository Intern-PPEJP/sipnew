 ...
 * Page class
 */
class t_jenis_add extends t_jenis
{
	...
	// Page object name
	public $PageObjName = "t_jenis_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdjenis") !== NULL) {
				...
				$this->setKey("kdjenis", $this->kdjenis->CurrentValue); // Set up key
			} else {
				$this->setKey("kdjenis", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_jenisview.php")

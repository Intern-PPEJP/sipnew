 ...
 * Page class
 */
class real_keu_pelatihan_list extends real_keu_pelatihan
{
	...
	// Table name
	public $TableName = 'real_keu_pelatihan';

	// Page object name
	public $PageObjName = "real_keu_pelatihan_list";

	// Grid form hidden field names
	public $FormName = "freal_keu_pelatihanlist";
	...
	public function __construct()
	{
		...
		// Table object (real_keu_pelatihan)
		if (!isset($GLOBALS["real_keu_pelatihan"]) || get_class($GLOBALS["real_keu_pelatihan"]) == PROJECT_NAMESPACE . "real_keu_pelatihan") {
			$GLOBALS["real_keu_pelatihan"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["real_keu_pelatihan"];
		}
		...
		$this->AddUrl = "real_keu_pelatihanadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "real_keu_pelatihandelete.php";
		$this->MultiUpdateUrl = "real_keu_pelatihanupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'real_keu_pelatihan');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option freal_keu_pelatihanlistsrch";
	...
	public function terminate($url = "")
	{
		...
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($real_keu_pelatihan);
				$doc->Text = @$content;
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"freal_keu_pelatihanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"freal_keu_pelatihanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.freal_keu_pelatihanlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.freal_keu_pelatihanlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.freal_keu_pelatihanlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.freal_keu_pelatihanlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_real_keu_pelatihan" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_real_keu_pelatihan\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.freal_keu_pelatihanlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	function Page_Load() {
		...
		$GLOBALS["ExportFileName"] = "2. Real.Keu.".$tampilbulan."Th." . @$_GET["tahun"];
	}
	...
	function Page_Exporting() {
		...
		#tdr { border-top: none;border-bottom: none; vertical-align: text-top; }
				...
				<table>
				<tr>
					<th colspan='9' id='tdk'>REALISASI KEUANGAN DIKLAT</th>
				</tr>
				<tr>
					<th colspan='9' id='tdk'>BALAI BESAR PENDIDIKAN DAN PELATIHAN EKSPOR INDONESIA</th>
				</tr>
				<tr>
					<th colspan='9' id='tdk'>".$tampilbulan.@$_GET["tahun"]."</th>
				</tr>
				<tr>
					<td colspan='9' id='tdk' style='text-align:right'>Lampiran-2</td>
				</tr>
				<tr>
					<td colspan='9' id='tdk'><b>I. PUSAT, DIPA/RUPIAH MURNI</b></td>
				</tr>
				<tr>
					<th colspan='9' id='tdk'></th>
				</tr>
				<tr>
					<th id='tdq' style='width:43px;'>NO</th>
					<th id='tdq' style='width:356px;'>TOPIK</th>
					<th id='tdq' style='width:96px;'>TEMPAT</th>
					<th id='tdq' style='width:117px;'>TANGGAL</th>
					<th id='tdq' style='width:121px;'>BIAYA</th>
					<th id='tdq' style='width:56px;'>JML PST</th>
					<th id='tdq' style='width:117px;'>JUMLAH</th>
					<th id='tdq' style='width:143px;'>TOTAL</th>
					<th id='tdq' style='width:155px;'>KETERANGAN</th>
				</tr>"; // Export header // Export header
			$_SESSION["totot"] = 0;
			$_SESSION["totalpeserta"] = 0;
	...
	function Row_Export($rs) {
		...
		$headertb = "</table>
				<table><tr><th colspan='9' id='tdk'></th></tr><tr><td colspan='9' id='tdk'><b>I. DAERAH</b></td></tr><tr><th colspan='9' id='tdk'></th></tr></table>
				<table><tr>
					<th id='tdq' style='width:43px;'>NO</th>
					<th id='tdq' style='width:356px;'>TOPIK</th>
					<th id='tdq' style='width:96px;'>TEMPAT</th>
		...
		if($btawal == $btakhir){
			$tgl_jd =  date("d", strtotime($rs["tawal"])) . " - " . CSFormatTanggal(date("d-m", strtotime($rs["takhir"])), $cetak_hari = false, $cetak_br = false, $singkatan_bulan = true);
		} else {
			$tgl_jd =  CSFormatTanggal(date("d-m", strtotime($rs["tawal"])), $cetak_hari = false, $cetak_br = false, $singkatan_bulan = true) . " - " . CSFormatTanggal(date("d-m", strtotime($rs["takhir"])), $cetak_hari = false, $cetak_br = false, $singkatan_bulan = true);
		}
		$this->ExportDoc->Text .= "
		<tr>
			<td align='center' valign='top' id='tdr'>".$_SESSION["no"]."</td>
			<td id='tdr'>".$this->kdjudul->ViewValue."</td>
			<td align='center' id='tdr'>".$this->kdkota->ViewValue."</td>
			<td align='center' id='tdr'>".$tgl_jd."</td>
			<td align='right' id='tdr'><span style='float:left;'>Rp </span><span style='float:right;'>".number_format($this->biaya->CurrentValue,0,',','.')."</span></td>
			<td align='center' id='tdr'>".$this->jmlpes->ViewValue."</td>
			<td align='right' id='tdr'><span style='float:left;'>Rp </span><span style='float:right;'>".number_format($this->jml->ViewValue,0,',','.')."</span></td>
			<td align='right' id='tdr'>".$rs["total"]."</td>
			<td id='tdr'>".$rs["ket"]."</td>
		</tr>";
		$_SESSION["w"] = $this->kdprop->CurrentValue;
		$_SESSION["no"]++;
		$_SESSION["noall"]++;
		$_SESSION["totalpeserta"] += $this->jmlpes->ViewValue;
		$_SESSION["totot"] += $this->jml->ViewValue;
	}

	// Page Exported event
	// $this->ExportDoc = export document object
	function Page_Exported() {
		$nom = $_SESSION["noall"] -1;
		$rr = "</table><br><table>
				<th align='center' valign='top' style='width:43px;'>".$nom."</th>
				<th align='center' style='width:356px;'><b>Jumlah</b></th>
				<th align='center' style='width:96px;'></th>
				<th align='center' style='width:117px;'></th>
				<th align='right' style='width:121px;'></th>
				<th align='center' style='width:56px;'>".$_SESSION["totalpeserta"]."</th>
				<th align='right' style='width:117px;'></th>
				<th align='right' style='width:143px;'><span style='float:left;'>Rp".number_format(@$_SESSION["totot"],0,',','.')."</span><span style='float:right;'></span></th>
				<th style='width:155px;'></th>
			</tr>";
		$this->ExportDoc->Text .= $rr."</table>"; // Export footer
		unset($_SESSION["no"]);
		unset($_SESSION["b"]);
		unset($_SESSION["w"]);
		unset($_SESSION["totalpeserta"]);
		unset($_SESSION["totot"]);

 ...
 * Page class
 */
class t_rwpekerjaan_add extends t_rwpekerjaan
{
	...
	// Page object name
	public $PageObjName = "t_rwpekerjaan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("rwkerjaid") !== NULL) {
				...
				$this->setKey("rwkerjaid", $this->rwkerjaid->CurrentValue); // Set up key
			} else {
				$this->setKey("rwkerjaid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_rwpekerjaanview.php")

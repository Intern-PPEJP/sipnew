 ...
 * Page class
 */
class t_pegawai_add extends t_pegawai
{
	...
	// Page object name
	public $PageObjName = "t_pegawai_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_peg") !== NULL) {
				...
				$this->setKey("id_peg", $this->id_peg->CurrentValue); // Set up key
			} else {
				$this->setKey("id_peg", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_pegawaiview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_peg->OldValue = $this->id_peg->CurrentValue;
		...
		$this->role->CurrentValue = 'Panitia';
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_peg'] = $this->id_peg->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->nip->CurrentValue != "") { // Check field with unique index
			$filter = "(`nip` = '" . AdjustSql($this->nip->CurrentValue, $this->Dbid) . "')";

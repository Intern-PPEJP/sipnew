 ...
 * Page class
 */
class t_coachingtahapan_add extends t_coachingtahapan
{
	...
	// Page object name
	public $PageObjName = "t_coachingtahapan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ctid") !== NULL) {
				...
				$this->setKey("ctid", $this->ctid->CurrentValue); // Set up key
			} else {
				$this->setKey("ctid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_coachingtahapanview.php")

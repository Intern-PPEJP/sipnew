 ...
 * Page class
 */
class t_pweb_add extends t_pweb
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdhistori") !== NULL) {
				...
				$this->setKey("kdhistori", $this->kdhistori->CurrentValue); // Set up key
			} else {
				$this->setKey("kdhistori", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_pwebview.php")
	...
	protected function validateForm()
	{
		...
		if (!CheckInteger($this->rkwid->FormValue)) {
			AddMessage($FormError, $this->rkwid->errorMessage());
		}
		if ($this->id->Required) {

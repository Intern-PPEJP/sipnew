 ...
 * Page class
 */
class t_biointruktur_delete extends t_biointruktur
{
	...
	// Page object name
	public $PageObjName = "t_biointruktur_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_biointrukturlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_biointrukturlist.php"); // Return to list
			}
		}
	}

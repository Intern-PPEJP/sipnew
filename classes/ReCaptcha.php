...
class ReCaptcha implements CaptchaInterface
{
	...
	// Private key
	public $ReCaptchaPrivateKey = "6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe";
	...
	public function validate()
	{
		...
		if ($this->Response == @$_SESSION[SESSION_CAPTCHA_CODE]) {
			...
			$recaptcha = new \ReCaptcha\ReCaptcha($this->ReCaptchaPrivateKey, new \ReCaptcha\RequestMethod\Post());

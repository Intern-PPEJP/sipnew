 ...
 * Page class
 */
class t_userlevelpermissions_list extends t_userlevelpermissions
{
	...
	// Table name
	public $TableName = 't_userlevelpermissions';

	// Page object name
	public $PageObjName = "t_userlevelpermissions_list";

	// Grid form hidden field names
	public $FormName = "ft_userlevelpermissionslist";
	...
	public function __construct()
	{
		...
		// Table object (t_userlevelpermissions)
		if (!isset($GLOBALS["t_userlevelpermissions"]) || get_class($GLOBALS["t_userlevelpermissions"]) == PROJECT_NAMESPACE . "t_userlevelpermissions") {
			$GLOBALS["t_userlevelpermissions"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t_userlevelpermissions"];
		}
		...
		$this->AddUrl = "t_userlevelpermissionsadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t_userlevelpermissionsdelete.php";
		$this->MultiUpdateUrl = "t_userlevelpermissionsupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't_userlevelpermissions');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft_userlevelpermissionslistsrch";
	...
	public function terminate($url = "")
	{
		...
		if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
			...
			if (class_exists($class)) {
				$doc = new $class($t_userlevelpermissions);
				$doc->Text = @$content;
	...
	protected function setupKeyValues($key)
	{
		...
		if (count($arKeyFlds) >= 2) {
			$this->user_level_id->setOldValue($arKeyFlds[0]);
			if (!is_numeric($this->user_level_id->OldValue))
				return FALSE;
			$this->table_name->setOldValue($arKeyFlds[1]);
		}
		return TRUE;
	}
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft_userlevelpermissionslistsrch", $filters);
	...
	{
		$where = "";
		$this->buildBasicSearchSql($where, $this->table_name, $arKeywords, $type);
		return $where;
	}
	...
	public function renderListOptions()
	{
		...
		$opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->user_level_id->CurrentValue . Config("COMPOSITE_KEY_SEPARATOR") . $this->table_name->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft_userlevelpermissionslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft_userlevelpermissionslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.ft_userlevelpermissionslist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadOldRecord()
	{
		...
		if (strval($this->getKey("user_level_id")) != "")
			$this->user_level_id->OldValue = $this->getKey("user_level_id"); // user_level_id
		else
			$validKey = FALSE;
		if (strval($this->getKey("table_name")) != "")
			$this->table_name->OldValue = $this->getKey("table_name"); // table_name
		else
			$validKey = FALSE;
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft_userlevelpermissionslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;

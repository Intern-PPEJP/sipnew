 ...
 * Page class
 */
class t_kat_produk_addopt extends t_kat_produk
{
	...
	// Page object name
	public $PageObjName = "t_kat_produk_addopt";
	...
	protected function loadFormValues()
	{
		...
		if (!$this->Kategori_Produk->IsDetailKey) {
			$this->Kategori_Produk->setFormValue(ConvertFromUtf8($val));
		}
	}
	...
	{
		global $CurrentForm;
		$this->Kategori_Produk->CurrentValue = ConvertToUtf8($this->Kategori_Produk->FormValue);
	}

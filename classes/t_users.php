...
class t_users extends DbTable
{
	...
	public function __construct()
	{
		...
		// username
		$this->username = new DbField('t_users', 't_users', 'x_username', 'username', '`username`', '`username`', 200, 25, -1, FALSE, '`username`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->username->Lookup = new Lookup('username', 't_pegawai', FALSE, 'nip', ["nip","nama","",""], [], [], [], [], [], [], '', '');
		$this->fields['username'] = &$this->username;

		// pass
		$this->pass = new DbField('t_users', 't_users', 'x_pass', 'pass', '`pass`', '`pass`', 201, 65535, -1, FALSE, '`pass`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->pass->Required = TRUE; // Required field
		$this->pass->Sortable = TRUE; // Allow sort
		$this->fields['pass'] = &$this->pass;

		// level
		$this->level = new DbField('t_users', 't_users', 'x_level', 'level', '`level`', '`level`', 3, 2, -1, FALSE, '`level`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevel
		$this->_userlevel = new DbField('t_users', 't_users', 'x__userlevel', 'userlevel', '`userlevel`', '`userlevel`', 3, 11, -1, FALSE, '`userlevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->_userlevel->Lookup = new Lookup('userlevel', 't_userlevels', FALSE, 'user_level_id', ["user_level_name","","",""], [], [], [], [], [], [], '', '');
		$this->_userlevel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['userlevel'] = &$this->_userlevel;

		// aktif
		$this->aktif = new DbField('t_users', 't_users', 'x_aktif', 'aktif', '`aktif`', '`aktif`', 202, 1, -1, FALSE, '`aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->aktif->Lookup = new Lookup('aktif', 't_users', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->aktif->OptionCount = 2;
		$this->fields['aktif'] = &$this->aktif;

		// created_at
		$this->created_at = new DbField('t_users', 't_users', 'x_created_at', 'created_at', '`created_at`', CastDateFieldForLike("`created_at`", 0, "DB"), 135, 19, 0, FALSE, '`created_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_at->Sortable = TRUE; // Allow sort
		$this->created_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['created_at'] = &$this->created_at;

		// user_created_by
		$this->user_created_by = new DbField('t_users', 't_users', 'x_user_created_by', 'user_created_by', '`user_created_by`', '`user_created_by`', 200, 100, -1, FALSE, '`user_created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_created_by->Sortable = TRUE; // Allow sort
		$this->fields['user_created_by'] = &$this->user_created_by;

		// updated_at
		$this->updated_at = new DbField('t_users', 't_users', 'x_updated_at', 'updated_at', '`updated_at`', CastDateFieldForLike("`updated_at`", 0, "DB"), 135, 19, 0, FALSE, '`updated_at`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->updated_at->Sortable = TRUE; // Allow sort
		$this->updated_at->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['updated_at'] = &$this->updated_at;

		// user_updated_by
		$this->user_updated_by = new DbField('t_users', 't_users', 'x_user_updated_by', 'user_updated_by', '`user_updated_by`', '`user_updated_by`', 200, 100, -1, FALSE, '`user_updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t_users`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t_usersedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t_usersadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t_usersview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t_usersview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t_usersadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t_usersadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_usersedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_usersadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t_usersdelete.php", $this->getUrlParm());
	}

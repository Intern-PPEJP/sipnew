...
/**
 * Table class for v_faskurdetail
 */
class v_faskurdetail extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_faskurdetail';
		$this->TableName = 'v_faskurdetail';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_faskurdetail`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// kurikulumid
		$this->kurikulumid = new DbField('v_faskurdetail', 'v_faskurdetail', 'x_kurikulumid', 'kurikulumid', '`kurikulumid`', '`kurikulumid`', 3, 11, -1, FALSE, '`kurikulumid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kurikulumid->Sortable = TRUE; // Allow sort
		$this->kurikulumid->Lookup = new Lookup('kurikulumid', 't_kurikulum', FALSE, 'kurikulumid', ["kurikulum","","",""], [], [], [], [], [], [], '`kurikulum` ASC', '');
		$this->kurikulumid->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['kurikulumid'] = &$this->kurikulumid;

		// bioid
		$this->bioid = new DbField('v_faskurdetail', 'v_faskurdetail', 'x_bioid', 'bioid', '`bioid`', '`bioid`', 3, 11, -1, FALSE, '`bioid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kurikulum
		$this->kurikulum = new DbField('v_faskurdetail', 'v_faskurdetail', 'x_kurikulum', 'kurikulum', '`kurikulum`', '`kurikulum`', 200, 255, -1, FALSE, '`kurikulum`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->kurikulum->Required = TRUE; // Required field
		$this->kurikulum->Sortable = TRUE; // Allow sort
		$this->fields['kurikulum'] = &$this->kurikulum;

		// nama
		$this->nama = new DbField('v_faskurdetail', 'v_faskurdetail', 'x_nama', 'nama', '`nama`', '`nama`', 200, 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Required = TRUE; // Required field
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// tgllahir
		$this->tgllahir = new DbField('v_faskurdetail', 'v_faskurdetail', 'x_tgllahir', 'tgllahir', '`tgllahir`', CastDateFieldForLike("`tgllahir`", 0, "DB"), 133, 10, 0, FALSE, '`tgllahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_faskurdetail`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_faskurdetailview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_faskurdetailedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_faskurdetailadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_faskurdetailview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_faskurdetailview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_faskurdetailadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_faskurdetailadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_faskurdetailedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_faskurdetailadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_faskurdetaildelete.php", $this->getUrlParm());
	}

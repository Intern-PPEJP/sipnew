 ...
 * Page class
 */
class t_ecp_view extends t_ecp
{
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID_ECP") !== NULL) {
				...
				$returnUrl = "t_ecplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t_ecplist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t_ecplist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {

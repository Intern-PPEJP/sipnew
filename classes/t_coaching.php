...
/**
 * Table class for t_coaching
 */
class t_coaching extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't_coaching';
		$this->TableName = 't_coaching';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_coaching`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// kdcoaching
		$this->kdcoaching = new DbField('t_coaching', 't_coaching', 'x_kdcoaching', 'kdcoaching', '`kdcoaching`', '`kdcoaching`', 3, 10, -1, FALSE, '`kdcoaching`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->kdcoaching->IsAutoIncrement = TRUE; // Autoincrement field
		$this->kdcoaching->IsPrimaryKey = TRUE; // Primary key field
		$this->kdcoaching->Sortable = TRUE; // Allow sort
		$this->kdcoaching->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['kdcoaching'] = &$this->kdcoaching;

		// rkid
		$this->rkid = new DbField('t_coaching', 't_coaching', 'x_rkid', 'rkid', '`rkid`', '`rkid`', 3, 11, -1, FALSE, '`rkid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kdtahapan
		$this->kdtahapan = new DbField('t_coaching', 't_coaching', 'x_kdtahapan', 'kdtahapan', '`kdtahapan`', '`kdtahapan`', 3, 11, -1, FALSE, '`kdtahapan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kdtahapan->Nullable = FALSE; // NOT NULL field
		$this->kdtahapan->Required = TRUE; // Required field
		$this->kdtahapan->Sortable = TRUE; // Allow sort
		$this->kdtahapan->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->kdtahapan->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->kdtahapan->Lookup = new Lookup('kdtahapan', 't_tahapan', FALSE, 'kdtahapan', ["Tahapan","","",""], [], [], [], [], [], [], '', '');
		$this->kdtahapan->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['kdtahapan'] = &$this->kdtahapan;

		// kdkursil
		$this->kdkursil = new DbField('t_coaching', 't_coaching', 'x_kdkursil', 'kdkursil', '`kdkursil`', '`kdkursil`', 200, 12, -1, FALSE, '`kdkursil`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kdkursil->Nullable = FALSE; // NOT NULL field
		...
		$this->kdkursil->Lookup = new Lookup('kdkursil', 't_juduldetail', FALSE, 'kdkursil', ["kdkursil","revisi","tgl_terbit",""], [], [], [], [], [], [], '`tgl_terbit` DESC', '');
		$this->fields['kdkursil'] = &$this->kdkursil;

		// tawal
		$this->tawal = new DbField('t_coaching', 't_coaching', 'x_tawal', 'tawal', '`tawal`', CastDateFieldForLike("`tawal`", 0, "DB"), 135, 19, 0, FALSE, '`tawal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tawal->Nullable = FALSE; // NOT NULL field
		...
		// takhir
		$this->takhir = new DbField('t_coaching', 't_coaching', 'x_takhir', 'takhir', '`takhir`', CastDateFieldForLike("`takhir`", 0, "DB"), 135, 19, 0, FALSE, '`takhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->takhir->Nullable = FALSE; // NOT NULL field
		...
		// jmlhari
		$this->jmlhari = new DbField('t_coaching', 't_coaching', 'x_jmlhari', 'jmlhari', '`jmlhari`', '`jmlhari`', 2, 5, -1, FALSE, '`jmlhari`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jmlhari->Nullable = FALSE; // NOT NULL field
		$this->jmlhari->Required = TRUE; // Required field
		$this->jmlhari->Sortable = TRUE; // Allow sort
		$this->jmlhari->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['jmlhari'] = &$this->jmlhari;

		// kdprop
		$this->kdprop = new DbField('t_coaching', 't_coaching', 'x_kdprop', 'kdprop', '`kdprop`', '`kdprop`', 3, 11, -1, FALSE, '`kdprop`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kdprop->IsForeignKey = TRUE; // Foreign key field
		$this->kdprop->Nullable = FALSE; // NOT NULL field
		...
		// ketua
		$this->ketua = new DbField('t_coaching', 't_coaching', 'x_ketua', 'ketua', '`ketua`', '`ketua`', 200, 40, -1, FALSE, '`ketua`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ketua->Nullable = FALSE; // NOT NULL field
		...
		// sekretaris
		$this->sekretaris = new DbField('t_coaching', 't_coaching', 'x_sekretaris', 'sekretaris', '`sekretaris`', '`sekretaris`', 200, 40, -1, FALSE, '`sekretaris`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sekretaris->Nullable = FALSE; // NOT NULL field
		...
		// bendahara
		$this->bendahara = new DbField('t_coaching', 't_coaching', 'x_bendahara', 'bendahara', '`bendahara`', '`bendahara`', 200, 40, -1, FALSE, '`bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bendahara->Nullable = FALSE; // NOT NULL field
		...
		// status
		$this->status = new DbField('t_coaching', 't_coaching', 'x_status', 'status', '`status`', '`status`', 200, 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->status->Nullable = FALSE; // NOT NULL field
		$this->status->Required = TRUE; // Required field
		$this->status->Sortable = TRUE; // Allow sort
		$this->status->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->status->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
		$this->status->Lookup = new Lookup('status', 't_coaching', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
		$this->status->OptionCount = 5;
		$this->status->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['status'] = &$this->status;

		// jenisevaluasi
		$this->jenisevaluasi = new DbField('t_coaching', 't_coaching', 'x_jenisevaluasi', 'jenisevaluasi', '`jenisevaluasi`', '`jenisevaluasi`', 200, 25, -1, FALSE, '`jenisevaluasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
	...
	public function getMasterFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "t_rkcoaching") {
			...
			if ($this->kdprop->getSessionValue() != "")
				$masterFilter .= " AND `area`=" . QuotedValue($this->kdprop->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $masterFilter;
	...
	public function getDetailFilter()
	{
		...
		if ($this->getCurrentMasterTable() == "t_rkcoaching") {
			if ($this->rkid->getSessionValue() != "")
				...
				return "";
			if ($this->kdprop->getSessionValue() != "")
				$detailFilter .= " AND `kdprop`=" . QuotedValue($this->kdprop->getSessionValue(), DATATYPE_NUMBER, "DB");
			else
				return "";
		}
		return $detailFilter;
	...
	{
		return "`rkid`=@rkid@ AND `kdprop`=@kdprop@";
	}

	// Table level SQL
	public function getSqlFrom() // From
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t_coaching`";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->kdcoaching->setDbValue($conn->insert_ID());
			$rs['kdcoaching'] = $this->kdcoaching->DbValue;
	...
	protected function deleteSql(&$rs, $where = "", $curfilter = TRUE)
	{
		...
		if (is_array($where))
			$where = $this->arrayToFilter($where);
		if ($rs) {
			if (array_key_exists('kdcoaching', $rs))
				AddFilter($where, QuotedName('kdcoaching', $this->Dbid) . '=' . QuotedValue($rs['kdcoaching'], $this->kdcoaching->DataType, $this->Dbid));
		}
		$filter = ($curfilter) ? $this->CurrentFilter : "";
		AddFilter($filter, $where);
		if ($filter != "")
	...
	public function getRecordFilter($row = NULL)
	{
		...
		if (is_array($row))
			$val = array_key_exists('kdcoaching', $row) ? $row['kdcoaching'] : NULL;
		else
			$val = $this->kdcoaching->OldValue !== NULL ? $this->kdcoaching->OldValue : $this->kdcoaching->CurrentValue;
		if (!is_numeric($val))
			return "0=1"; // Invalid key
		if ($val == NULL)
			return "0=1"; // Invalid key
		else
			$keyFilter = str_replace("@kdcoaching@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
		return $keyFilter;
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "t_coachingedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t_coachingadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t_coachingview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t_coachingview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t_coachingadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t_coachingadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_coachingedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_coachingadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t_coachingdelete.php", $this->getUrlParm());
	}
	...
	public function addMasterUrl($url)
	{
		if ($this->getCurrentMasterTable() == "t_rkcoaching" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
			...
			$url .= "&fk_area=" . urlencode($this->kdprop->CurrentValue);
		}
		return $url;
	}
	...
	{
		$json = "";
		$json .= "kdcoaching:" . JsonEncode($this->kdcoaching->CurrentValue, "number");
		$json = "{" . $json . "}";
		if ($htmlEncode)
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($parm != "")
			$url .= $parm . "&";
		if ($this->kdcoaching->CurrentValue != NULL) {
			$url .= "kdcoaching=" . urlencode($this->kdcoaching->CurrentValue);
		} else {
	...
	public function getRecordKeys()
	{
		...
		if (Param("key_m") !== NULL) {
			...
			if (Param("kdcoaching") !== NULL)
				$arKeys[] = Param("kdcoaching");
	...
	public function getFilterFromRecordKeys($setCurrent = TRUE)
	{
		...
		foreach ($arKeys as $key) {
			...
			if ($setCurrent)
				$this->kdcoaching->CurrentValue = $key;
			else
				$this->kdcoaching->OldValue = $key;
	...
	public function renderEditRow()
	{
		...
		$this->jmlhari->EditValue = $this->jmlhari->CurrentValue;

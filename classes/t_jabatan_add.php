 ...
 * Page class
 */
class t_jabatan_add extends t_jabatan
{
	...
	// Page object name
	public $PageObjName = "t_jabatan_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdjabat") !== NULL) {
				...
				$this->setKey("kdjabat", $this->kdjabat->CurrentValue); // Set up key
			} else {
				$this->setKey("kdjabat", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_jabatanview.php")

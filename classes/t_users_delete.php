 ...
 * Page class
 */
class t_users_delete extends t_users
{
	...
	// Page object name
	public $PageObjName = "t_users_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_userslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_userslist.php"); // Return to list
			}
		}
	}

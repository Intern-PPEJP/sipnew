 ...
 * Page class
 */
class petri_list extends petri
{
	...
	// Page object name
	public $PageObjName = "petri_list";

	// Grid form hidden field names
	public $FormName = "fpetrilist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "petriadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "petridelete.php";
		$this->MultiUpdateUrl = "petriupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fpetrilistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->kdprop_perusahaan->AdvancedSearch->toJson(), ","); // Field kdprop_perusahaan
		$filterList = Concat($filterList, $this->kdkota_perusahaan->AdvancedSearch->toJson(), ","); // Field kdkota_perusahaan
		...
		$filterList = Concat($filterList, $this->independen->AdvancedSearch->toJson(), ","); // Field independen
		$filterList = Concat($filterList, $this->kdproduknafed->AdvancedSearch->toJson(), ","); // Field kdproduknafed
		$filterList = Concat($filterList, $this->kdproduknafed2->AdvancedSearch->toJson(), ","); // Field kdproduknafed2
		$filterList = Concat($filterList, $this->kdproduknafed3->AdvancedSearch->toJson(), ","); // Field kdproduknafed3
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fpetrilistsrch", $filters);
	...
	protected function restoreFilterList()
	{
		...
		// Field kdprop_perusahaan
		$this->kdprop_perusahaan->AdvancedSearch->SearchValue = @$filter["x_kdprop_perusahaan"];
		$this->kdprop_perusahaan->AdvancedSearch->SearchOperator = @$filter["z_kdprop_perusahaan"];
		$this->kdprop_perusahaan->AdvancedSearch->SearchCondition = @$filter["v_kdprop_perusahaan"];
		$this->kdprop_perusahaan->AdvancedSearch->SearchValue2 = @$filter["y_kdprop_perusahaan"];
		$this->kdprop_perusahaan->AdvancedSearch->SearchOperator2 = @$filter["w_kdprop_perusahaan"];
		$this->kdprop_perusahaan->AdvancedSearch->save();

		// Field kdkota_perusahaan
		$this->kdkota_perusahaan->AdvancedSearch->SearchValue = @$filter["x_kdkota_perusahaan"];
		$this->kdkota_perusahaan->AdvancedSearch->SearchOperator = @$filter["z_kdkota_perusahaan"];
		$this->kdkota_perusahaan->AdvancedSearch->SearchCondition = @$filter["v_kdkota_perusahaan"];
		$this->kdkota_perusahaan->AdvancedSearch->SearchValue2 = @$filter["y_kdkota_perusahaan"];
		$this->kdkota_perusahaan->AdvancedSearch->SearchOperator2 = @$filter["w_kdkota_perusahaan"];
		$this->kdkota_perusahaan->AdvancedSearch->save();
		...
		// Field independen
		$this->independen->AdvancedSearch->SearchValue = @$filter["x_independen"];
		$this->independen->AdvancedSearch->SearchOperator = @$filter["z_independen"];
		$this->independen->AdvancedSearch->SearchCondition = @$filter["v_independen"];
		$this->independen->AdvancedSearch->SearchValue2 = @$filter["y_independen"];
		$this->independen->AdvancedSearch->SearchOperator2 = @$filter["w_independen"];
		$this->independen->AdvancedSearch->save();
		...
		// Field kdproduknafed2
		$this->kdproduknafed2->AdvancedSearch->SearchValue = @$filter["x_kdproduknafed2"];
		$this->kdproduknafed2->AdvancedSearch->SearchOperator = @$filter["z_kdproduknafed2"];
		$this->kdproduknafed2->AdvancedSearch->SearchCondition = @$filter["v_kdproduknafed2"];
		$this->kdproduknafed2->AdvancedSearch->SearchValue2 = @$filter["y_kdproduknafed2"];
		$this->kdproduknafed2->AdvancedSearch->SearchOperator2 = @$filter["w_kdproduknafed2"];
		$this->kdproduknafed2->AdvancedSearch->save();

		// Field kdproduknafed3
		$this->kdproduknafed3->AdvancedSearch->SearchValue = @$filter["x_kdproduknafed3"];
		$this->kdproduknafed3->AdvancedSearch->SearchOperator = @$filter["z_kdproduknafed3"];
		$this->kdproduknafed3->AdvancedSearch->SearchCondition = @$filter["v_kdproduknafed3"];
		$this->kdproduknafed3->AdvancedSearch->SearchValue2 = @$filter["y_kdproduknafed3"];
		$this->kdproduknafed3->AdvancedSearch->SearchOperator2 = @$filter["w_kdproduknafed3"];
		$this->kdproduknafed3->AdvancedSearch->save();
	...
	protected function advancedSearchWhere($default = FALSE)
	{
		...
		$this->buildSearchSql($where, $this->kdprop_perusahaan, $default, FALSE); // kdprop_perusahaan
		$this->buildSearchSql($where, $this->kdkota_perusahaan, $default, FALSE); // kdkota_perusahaan
		...
		$this->buildSearchSql($where, $this->independen, $default, FALSE); // independen
		$this->buildSearchSql($where, $this->kdproduknafed, $default, FALSE); // kdproduknafed
		$this->buildSearchSql($where, $this->kdproduknafed2, $default, FALSE); // kdproduknafed2
		$this->buildSearchSql($where, $this->kdproduknafed3, $default, FALSE); // kdproduknafed3
		...
		if (!$default && $this->Command == "search") {
			...
			$this->kdprop_perusahaan->AdvancedSearch->save(); // kdprop_perusahaan
			$this->kdkota_perusahaan->AdvancedSearch->save(); // kdkota_perusahaan
			...
			$this->independen->AdvancedSearch->save(); // independen
			$this->kdproduknafed->AdvancedSearch->save(); // kdproduknafed
			$this->kdproduknafed2->AdvancedSearch->save(); // kdproduknafed2
			$this->kdproduknafed3->AdvancedSearch->save(); // kdproduknafed3
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->kdjudul, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->nama, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->telp, $arKeywords, $type);
		...
		$this->buildBasicSearchSql($where, $this->independen, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->kdproduknafed, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->kdproduknafed2, $arKeywords, $type);
		$this->buildBasicSearchSql($where, $this->kdproduknafed3, $arKeywords, $type);
	...
	protected function checkSearchParms()
	{
		...
		if ($this->namap->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->kdprop_perusahaan->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->kdkota_perusahaan->AdvancedSearch->issetSession())
			return TRUE;
		...
		if ($this->nexport->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->independen->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->kdproduknafed->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->kdproduknafed2->AdvancedSearch->issetSession())
			return TRUE;
		if ($this->kdproduknafed3->AdvancedSearch->issetSession())
			return TRUE;
	...
	protected function resetAdvancedSearchParms()
	{
		...
		$this->kdprop_perusahaan->AdvancedSearch->unsetSession();
		$this->kdkota_perusahaan->AdvancedSearch->unsetSession();
		...
		$this->independen->AdvancedSearch->unsetSession();
		$this->kdproduknafed->AdvancedSearch->unsetSession();
		$this->kdproduknafed2->AdvancedSearch->unsetSession();
		$this->kdproduknafed3->AdvancedSearch->unsetSession();
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->kdprop_perusahaan); // kdprop_perusahaan
			$this->updateSort($this->kdkota_perusahaan); // kdkota_perusahaan
			...
			$this->updateSort($this->independen); // independen
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->_email->setSort("");
				$this->namap->setSort("");
				$this->kdprop_perusahaan->setSort("");
				$this->kdkota_perusahaan->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fpetrilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpetrilistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fpetrilist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function loadSearchValues()
	{
		...
		// kdprop_perusahaan
		if (!$this->isAddOrEdit() && $this->kdprop_perusahaan->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->kdprop_perusahaan->AdvancedSearch->SearchValue != "" || $this->kdprop_perusahaan->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// kdkota_perusahaan
		if (!$this->isAddOrEdit() && $this->kdkota_perusahaan->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->kdkota_perusahaan->AdvancedSearch->SearchValue != "" || $this->kdkota_perusahaan->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// independen
		if (!$this->isAddOrEdit() && $this->independen->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->independen->AdvancedSearch->SearchValue != "" || $this->independen->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
		...
		// kdproduknafed2
		if (!$this->isAddOrEdit() && $this->kdproduknafed2->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->kdproduknafed2->AdvancedSearch->SearchValue != "" || $this->kdproduknafed2->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}

		// kdproduknafed3
		if (!$this->isAddOrEdit() && $this->kdproduknafed3->AdvancedSearch->get()) {
			$got = TRUE;
			if (($this->kdproduknafed3->AdvancedSearch->SearchValue != "" || $this->kdproduknafed3->AdvancedSearch->SearchValue2 != "") && $this->Command == "")
				$this->Command = "search";
		}
	...
	public function loadRowValues($rs = NULL)
	{
		...
		$this->kdprop_perusahaan->setDbValue($row['kdprop_perusahaan']);
		$this->kdkota_perusahaan->setDbValue($row['kdkota_perusahaan']);
	...
	protected function newRow()
	{
		...
		$row['email'] = NULL;
		$row['namap'] = NULL;
		$row['kdprop_perusahaan'] = NULL;
		$row['kdkota_perusahaan'] = NULL;
		$row['kdkategori'] = NULL;
		$row['kdjenis'] = NULL;
		$row['kdskala'] = NULL;
		$row['kdexport'] = NULL;
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpetrilist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpetrilist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpetrilist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
			...
			return '<button id="emf_petri" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_petri\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpetrilist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpetrilistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
		...
		if (IsMobile())
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"petrisrch.php\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		else
			$item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-table=\"petri\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SearchBtn',url:'petrisrch.php'});\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

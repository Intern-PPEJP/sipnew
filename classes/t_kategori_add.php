 ...
 * Page class
 */
class t_kategori_add extends t_kategori
{
	...
	// Page object name
	public $PageObjName = "t_kategori_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdkategori") !== NULL) {
				...
				$this->setKey("kdkategori", $this->kdkategori->CurrentValue); // Set up key
			} else {
				$this->setKey("kdkategori", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_kategoriview.php")

 ...
 * Page class
 */
class t_rwtraining_add extends t_rwtraining
{
	...
	// Page object name
	public $PageObjName = "t_rwtraining_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("rwtrainingid") !== NULL) {
				...
				$this->setKey("rwtrainingid", $this->rwtrainingid->CurrentValue); // Set up key
			} else {
				$this->setKey("rwtrainingid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_rwtrainingview.php")

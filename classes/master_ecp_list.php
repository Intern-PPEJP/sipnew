 ...
 * Page class
 */
class master_ecp_list extends master_ecp
{
	...
	// Table name
	public $TableName = 'master_ecp';

	// Page object name
	public $PageObjName = "master_ecp_list";

	// Grid form hidden field names
	public $FormName = "fmaster_ecplist";
	...
	public function __construct()
	{
		...
		// Table object (master_ecp)
		if (!isset($GLOBALS["master_ecp"]) || get_class($GLOBALS["master_ecp"]) == PROJECT_NAMESPACE . "master_ecp") {
			$GLOBALS["master_ecp"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["master_ecp"];
		}
		...
		$this->AddUrl = "master_ecpadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "master_ecpdelete.php";
		$this->MultiUpdateUrl = "master_ecpupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'master_ecp');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fmaster_ecplistsrch";
	...
	public function run()
	{
		...
		$this->setupLookupOptions($this->produk);
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "fmaster_ecplistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fmaster_ecplistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmaster_ecplistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fmaster_ecplist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fmaster_ecplistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;

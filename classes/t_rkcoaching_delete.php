 ...
 * Page class
 */
class t_rkcoaching_delete extends t_rkcoaching
{
	...
	// Page object name
	public $PageObjName = "t_rkcoaching_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_rkcoachinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_rkcoachinglist.php"); // Return to list
			}
		}
	}

 ...
 * Page class
 */
class t_coaching_delete extends t_coaching
{
	...
	// Page object name
	public $PageObjName = "t_coaching_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_coachinglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_coachinglist.php"); // Return to list
			}
		}
	}

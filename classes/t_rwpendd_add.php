 ...
 * Page class
 */
class t_rwpendd_add extends t_rwpendd
{
	...
	// Page object name
	public $PageObjName = "t_rwpendd_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("penddid") !== NULL) {
				...
				$this->setKey("penddid", $this->penddid->CurrentValue); // Set up key
			} else {
				$this->setKey("penddid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_rwpenddview.php")

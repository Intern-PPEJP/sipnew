 ...
 * Page class
 */
class t_judul_delete extends t_judul
{
	...
	// Page object name
	public $PageObjName = "t_judul_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_judullist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_judullist.php"); // Return to list
			}
		}
	}

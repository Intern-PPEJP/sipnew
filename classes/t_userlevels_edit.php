 ...
 * Page class
 */
class t_userlevels_edit extends t_userlevels
{
	...
	// Page object name
	public $PageObjName = "t_userlevels_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("user_level_id") !== NULL) {
				...
				$this->user_level_id->setQueryStringValue(Key(0));
				$this->user_level_id->setOldValue($this->user_level_id->QueryStringValue);
				...
				$this->user_level_id->setQueryStringValue(Route(2));
				$this->user_level_id->setOldValue($this->user_level_id->QueryStringValue);
			} else {
			...
			if (Post("action") !== NULL) {
				...
				// Load key from Form
				if ($CurrentForm->hasValue("x_user_level_id")) {
					$this->user_level_id->setFormValue($CurrentForm->getValue("x_user_level_id"));
				}
			} else {

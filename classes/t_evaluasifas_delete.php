 ...
 * Page class
 */
class t_evaluasifas_delete extends t_evaluasifas
{
	...
	// Page object name
	public $PageObjName = "t_evaluasifas_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_evaluasifaslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_evaluasifaslist.php"); // Return to list
			}
		}
	}

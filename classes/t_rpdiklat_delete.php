 ...
 * Page class
 */
class t_rpdiklat_delete extends t_rpdiklat
{
	...
	// Page object name
	public $PageObjName = "t_rpdiklat_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_rpdiklatlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_rpdiklatlist.php"); // Return to list
			}
		}
	}

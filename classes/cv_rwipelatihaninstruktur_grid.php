 ...
 * Page class
 */
class cv_rwipelatihaninstruktur_grid extends cv_rwipelatihaninstruktur
{
	...
	// Page object name
	public $PageObjName = "cv_rwipelatihaninstruktur_grid";

	// Grid form hidden field names
	public $FormName = "fcv_rwipelatihaninstrukturgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($this->bioid->getSessionValue() != "") {
			$rsnew['bioid'] = $this->bioid->getSessionValue();
		}

 ...
 * Page class
 */
class t_ecp_delete extends t_ecp
{
	...
	// Page object name
	public $PageObjName = "t_ecp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_ecplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_ecplist.php"); // Return to list
			}
		}
	}

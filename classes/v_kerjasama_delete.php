 ...
 * Page class
 */
class v_kerjasama_delete extends v_kerjasama
{
	...
	// Page object name
	public $PageObjName = "v_kerjasama_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("v_kerjasamalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("v_kerjasamalist.php"); // Return to list
			}
		}
	}

 ...
 * Page class
 */
class t_pweb_delete extends t_pweb
{
	...
	// Page object name
	public $PageObjName = "t_pweb_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_pweblist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_pweblist.php"); // Return to list
			}
		}
	}

 ...
 * Page class
 */
class diklatpusat_view extends diklatpusat
{
	...
	// Page object name
	public $PageObjName = "diklatpusat_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("idpelat") !== NULL) {
				...
				$returnUrl = "diklatpusatlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "diklatpusatlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "diklatpusatlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {

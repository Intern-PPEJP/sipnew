 ...
 * Page class
 */
class t_rkwebinar_view extends t_rkwebinar
{
	...
	// Page object name
	public $PageObjName = "t_rkwebinar_view";
	...
	public function __construct()
	{
		...
		$keyUrl = "";
		if (Get("rkwid") !== NULL) {
			$this->RecKey["rkwid"] = Get("rkwid");
			$keyUrl .= "&amp;rkwid=" . urlencode($this->RecKey["rkwid"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("rkwid") !== NULL) {
				...
				$this->RecKey["rkwid"] = $this->rkwid->QueryStringValue;
			} elseif (IsApi() && Key(0) !== NULL) {
				$this->rkwid->setQueryStringValue(Key(0));
				$this->RecKey["rkwid"] = $this->rkwid->QueryStringValue;
			} elseif (Post("rkwid") !== NULL) {
				$this->rkwid->setFormValue(Post("rkwid"));
				$this->RecKey["rkwid"] = $this->rkwid->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->rkwid->setFormValue(Route(2));
				$this->RecKey["rkwid"] = $this->rkwid->FormValue;
			} else {
				$returnUrl = "t_rkwebinarlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t_rkwebinarlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t_rkwebinarlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {

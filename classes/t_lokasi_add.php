 ...
 * Page class
 */
class t_lokasi_add extends t_lokasi
{
	...
	// Page object name
	public $PageObjName = "t_lokasi_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdlokasi") !== NULL) {
				...
				$this->setKey("kdlokasi", $this->kdlokasi->CurrentValue); // Set up key
			} else {
				$this->setKey("kdlokasi", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_lokasiview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// kdlokasi
		$this->kdlokasi->setDbValueDef($rsnew, $this->kdlokasi->CurrentValue, 0, strval($this->kdlokasi->CurrentValue) == "");
		...
		if ($insertRow && $this->ValidateKey && strval($rsnew['kdlokasi']) == "") {

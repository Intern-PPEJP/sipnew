 ...
 * Page class
 */
class t_faskur_add extends t_faskur
{
	...
	// Page object name
	public $PageObjName = "t_faskur_add";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t_faskurlist.php"));
				else
		...
		if (IsApi()) {
			...
			if (Get("faskurid") !== NULL) {
				$this->faskurid->setQueryStringValue(Get("faskurid"));
				$this->setKey("faskurid", $this->faskurid->CurrentValue); // Set up key
			} else {
				$this->setKey("faskurid", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t_faskurlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t_faskurlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t_faskurview.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t_faskurlist.php"), "", $this->TableVar, TRUE);

 ...
 * Page class
 */
class t_bahasa_add extends t_bahasa
{
	...
	// Page object name
	public $PageObjName = "t_bahasa_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdbahasa") !== NULL) {
				...
				$this->setKey("kdbahasa", $this->kdbahasa->CurrentValue); // Set up key
			} else {
				$this->setKey("kdbahasa", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_bahasaview.php")

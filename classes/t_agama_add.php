 ...
 * Page class
 */
class t_agama_add extends t_agama
{
	...
	// Page object name
	public $PageObjName = "t_agama_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("kdagama") !== NULL) {
				...
				$this->setKey("kdagama", $this->kdagama->CurrentValue); // Set up key
			} else {
				$this->setKey("kdagama", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "t_agamaview.php")
